            ...
            <el-form :model="loginForm" ref="loginForm" label-width="0px" class="login-Form">
                ...
                <template>
                    <div class="join_formitem">
                        <div class = 'captcha'>
                            <el-input class="login-input" style="width: 150px" @focus="hideErrmsg" type="password" placeholder="请输入验证码" @keyup.enter.native="submitForm('loginForm')"
        ...
        <div class="forget-pwd-box" v-if="!loginPanelDisplay">
            ...
            <el-form ref="form" :model="forgetPwdForm" label-width="120px">
                ...
                <el-form-item>
                    ...
                    <el-input v-model="forgetPwdForm.newPwd" placeholder="请输入"></el-input>
                </el-form-item>
            </el-form>
            <div style="width: 100%;height: 40px;margin-top: 30px;">
                ...
                <div style="width:120px;display: inline-block;float: right">
                    <el-button class="v-1-0-0-Button-Minor" @click="loginPanelDisplay = !loginPanelDisplay" style="width: 120px;height: 40px;font-size: 14px;letter-spacing: 1px">
                        返回
                    </el-button>
                </div>
            </div>
        ...
        methods: {
            ...
            loginSuccess(res){
                if(res.status === 200){
                    ...
                    sessionStorage.setItem("loginUrl","/login_kys");
                    //验证如果是区域用户，绑定多个用户
...
<style scoped>
    .login-wrap {
        ...
        width: 100%;
        height: 100%;
        background-image: url("../../resource/img/login_bg_1_30_kys.jpg");
